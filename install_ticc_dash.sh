...
# Sources in repo
REPO_RAW_PY="https://raw.githubusercontent.com/OneByJorah/ChronoGuard/main/ticc-dash.py"
REPO_RAW_LOGO="https://raw.githubusercontent.com/OneByJorah/ChronoGuard/main/static/img/ticc-dash-logo.png"
